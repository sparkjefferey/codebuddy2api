...
本项目**仅供个人技术学习与研究使用,明确禁止任何商业用途**。

- 仅可使用**本人合法拥有**的 WorkBuddy / CodeBuddy 账号登录态,不得买卖、共享、代他人使用账号;
- 不得用于任何盈利、经营性、规模化对外提供服务的行为;
- 不得绕过、破解或滥用上游平台的付费/限额机制;
- 使用者须自行遵守所在地法律法规及上游服务条款,因滥用导致的账号封禁、法律责任等后果**由使用者自行承担**;
- 本项目与腾讯、OpenAI、Anthropic 无任何官方关联,不对使用后果作任何担保。
